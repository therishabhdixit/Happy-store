...
const cartTemsFromStroage = localStorage.getItem('cartItems') ? JSON.parse(localStorage.getItem('cartItems')) : []
...
const initialState = {
    cart: { cartItems: cartTemsFromStroage, shippingAddress: shippingAddressFromStorage },
